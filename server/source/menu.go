...
var menus = []model.SysBaseMenu{
	...
	{GVA_MODEL: global.GVA_MODEL{ID: 14, CreatedAt: time.Now(), UpdatedAt: time.Now()}, MenuLevel: 0, Hidden: true, ParentId: "0", Path: "systemTools", Name: "systemTools", Component: "view/systemTools/index.vue", Sort: 5, Meta: model.Meta{Title: "系统工具", Icon: "s-cooperation"}},
	...
	{GVA_MODEL: global.GVA_MODEL{ID: 10001, CreatedAt: time.Now(), UpdatedAt: time.Now()}, MenuLevel: 0, ParentId: "0", Path: "businessQuery", Name: "businessQuery", Hidden: false, Component: "view/routerHolder.vue", Sort: 0, Meta: model.Meta{Title: "业务查询", Icon: "search"}},
	{GVA_MODEL: global.GVA_MODEL{ID: 10002, CreatedAt: time.Now(), UpdatedAt: time.Now()}, MenuLevel: 1, ParentId: "10001", Path: "tbcell", Name: "tbcell", Hidden: false, Component: "view/businessQuery/tbcell/tbcell.vue", Sort: 0, Meta: model.Meta{Title: "小区/基站查询", Icon: "search"}},
	{GVA_MODEL: global.GVA_MODEL{ID: 10003, CreatedAt: time.Now(), UpdatedAt: time.Now()}, MenuLevel: 1, ParentId: "10001", Path: "tbkpi", Name: "tbkpi", Hidden: false, Component: "view/businessQuery/tbkpi/tbkpi.vue", Sort: 1, Meta: model.Meta{Title: "小区kpi查询", Icon: "data-line"}},
	{GVA_MODEL: global.GVA_MODEL{ID: 10004, CreatedAt: time.Now(), UpdatedAt: time.Now()}, MenuLevel: 0, ParentId: "0", Path: "dataManage", Name: "dataManage", Hidden: false, Component: "view/routerHolder.vue", Sort: 1, Meta: model.Meta{Title: "数据管理", Icon: "s-data"}},
	{GVA_MODEL: global.GVA_MODEL{ID: 10005, CreatedAt: time.Now(), UpdatedAt: time.Now()}, MenuLevel: 1, ParentId: "10004", Path: "importCSVtoDB", Name: "importCSVtoDB", Hidden: false, Component: "view/dataManage/import/importCSVtoDB.vue", Sort: 0, Meta: model.Meta{Title: "导入csv", Icon: "data-board"}},
	{GVA_MODEL: global.GVA_MODEL{ID: 10006, CreatedAt: time.Now(), UpdatedAt: time.Now()}, MenuLevel: 1, ParentId: "10004", Path: "exportDBtoCSV", Name: "exportDBtoCSV", Hidden: false, Component: "view/dataManage/export/exportDBtoCSV.vue", Sort: 1, Meta: model.Meta{Title: "导出csv", Icon: "data-board"}},
	{GVA_MODEL: global.GVA_MODEL{ID: 10007, CreatedAt: time.Now(), UpdatedAt: time.Now()}, MenuLevel: 1, ParentId: "10001", Path: "tbprb", Name: "tbprb", Hidden: false, Component: "view/businessQuery/tbprb/tbprb.vue", Sort: 2, Meta: model.Meta{Title: "prb信息统计查询", Icon: "data-line"}},
	{GVA_MODEL: global.GVA_MODEL{ID: 10008, CreatedAt: time.Now(), UpdatedAt: time.Now()}, MenuLevel: 0, ParentId: "0", Path: "dataAnalysis", Name: "dataAnalysis", Hidden: false, Component: "view/routerHolder.vue", Sort: 2, Meta: model.Meta{Title: "数据分析", Icon: "data-analysis"}},
	{GVA_MODEL: global.GVA_MODEL{ID: 10009, CreatedAt: time.Now(), UpdatedAt: time.Now()}, MenuLevel: 1, ParentId: "10008", Path: "tbc2i3", Name: "tbc2i3", Hidden: false, Component: "view/dataAnalysis/tbc2i3/tbc2i3.vue", Sort: 0, Meta: model.Meta{Title: "干扰三元组分析", Icon: "data-analysis"}},
}
